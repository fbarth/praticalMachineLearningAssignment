...
In other words, `r model$err.rate[500,1]*100`%. The confusion matrix can be calculated in the same way. Bellow you can see the confusion matrix. As you can see, the results are very good for all classes. 
